...
from .models import Authorization, CapabilityLease, OperationRequest, Decision
...
def test_expired_authorization_denies():
    ...
    try: r.issue_lease("a1",CapabilityLease("l2","a1","agent-1",frozenset({"build"}),a.issued_at,a.expires_at))
    except PermissionError: pass
    else: raise AssertionError("expired authorization issued a lease")
